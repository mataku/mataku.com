...
![](https://miro.medium.com/max/874/1*7ovPEYqRkg9Vd1FrGEz8fw.png "モジュールの依存図 (矢印の先を依存関係として指定している)")
...
![](https://miro.medium.com/max/1190/1*nQmLp4lUJvKA6f0te9kBIg.png "適当な個人アプリの apk で Analyze APK した様子")
