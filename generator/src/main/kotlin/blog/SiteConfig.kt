...
object SiteConfig {
  val footerHtml =
    ...
    <footer>
        ...
        <span class="footer-credit"><a href="/articles/privacy_policy">Privacy Policy</a></span>
    </footer>
    """.trimIndent()

  val headerActionsHtml =
    """
    <div class="header-actions">
        <a href="https://github.com/mataku" aria-label="GitHub" class="social-icon">
        ...
        <a href="/feed.xml" aria-label="Feed" class="social-icon">
            <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
